 ...
 */
public abstract class SiteLoaderForAB {
     ...
     */
    protected final double load(String urlToSite, SiteLoaderForAB.Currency currencyName){
    ...
    public abstract double load(SiteLoaderForAB.Currency currencyName, String date);
     ...
     * @return курс который мы нашли
     */
    protected abstract double handle(String content, SiteLoaderForAB.Currency currencyName);
}