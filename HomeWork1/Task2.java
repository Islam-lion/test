...
public class Task2 {
   ...
   //     int f = (5 + 7 > 20 ? 68 >= 68 : 22 * 2 >> two++) / --eight; // в тернарном выражении первая операнда это логическое выражение
                                                                    // а вторая операнда целочисленное выражение из за этого и ошибка
